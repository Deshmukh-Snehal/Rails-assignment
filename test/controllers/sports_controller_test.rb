...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { sport_equipments: @sport.sport_equipments, sport_name: @sport.sport_name, sport_player: @sport.sport_player } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { sport_equipments: @sport.sport_equipments, sport_name: @sport.sport_name, sport_player: @sport.sport_player } }
