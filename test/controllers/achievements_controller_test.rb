...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { awards: @achievement.awards, medals: @achievement.medals } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { awards: @achievement.awards, medals: @achievement.medals } }
